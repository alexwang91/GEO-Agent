...
Follow Loop V4 for audit-package work: reload state, state the package artifact being improved, add deterministic verification first, preserve recorded/fixture-only CI behavior, improve durable audit evidence, finish only after CI is green, and stop instead of faking unavailable live evidence. Do not weaken tests, evals, assertions, or acceptance criteria.
