...
Known state after V7-15 merges:
- V7-01 through V7-15 are DONE.
- V7-11 and V7-14 are complete.
- V7-16 through V7-38 are TODO.
...
4. Select `V7-16`: claim fidelity audit.
...
First TODO: `V7-16` after the V7-15 PR merges.
