...
Known state after V7-14 merges:
- V7-01 through V7-14 are DONE.
- V7-11 and V7-13 are complete.
- V7-15 through V7-38 are TODO.
...
4. Select `V7-15`: citation absorption metric.
...
First TODO: `V7-15` after the V7-14 PR merges.
