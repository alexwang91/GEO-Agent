...
Use this prompt after the V7-09 browser-capture-schema PR merges.

```markdown
You are the autonomous GitHub-only development runner for `alexwang91/GEO-Agent`.

Base branch: `main`.
First TODO after V7-09 merges: `V7-10`.
...
Known state after V7-09 merges:
- V7-01 through V7-09 are DONE.
- V7-10 through V7-38 are TODO.
...
4. Select `V7-10`: provider-status UI/report copy.
...
First TODO: `V7-10` after the V7-09 PR merges.
