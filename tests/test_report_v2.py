...
class ReportV2Tests(unittest.TestCase):
    ...
    def test_engine_component_summary_leads_with_per_engine_metrics(self):
        runs = (
            EngineRun("perplexity", "best Android watch", "2026-06-29T12:00:00+00:00", "HU", "en", "Huawei Watch Fit 5 is mentioned, but Apple Watch is also listed.", ("source-a",), ("Huawei Watch Fit 5",), ("Huawei Watch Fit 5",), ("example.com",)),
            EngineRun("chatgpt_search", "best fitness watch", "2026-06-29T12:01:00+00:00", "HU", "en", "Apple Watch and Samsung Galaxy Watch are listed as the shortlist.", ("source-b",), ("Apple Watch",), ("Apple Watch",), ("example.com",)),
            EngineRun("google_aio", "Huawei Watch Fit 5", "2026-06-29T12:02:00+00:00", "HU", "en", "Huawei Watch Fit 5 is cited from Huawei.", ("source-c",), ("Huawei Watch Fit 5",), ("Huawei Watch Fit 5",), ("consumer.huawei.com",)),
        )

        summary = build_engine_component_summary(runs, brand="Huawei", brand_domain="consumer.huawei.com", competitors=("Apple Watch", "Samsung Galaxy Watch"))
        ...
        self.assertEqual(set(summary["decomposition"]), {"selection", "absorption", "attribution"})
    ...
    def test_report_from_runs_has_engine_breakdown_and_directional_aggregate_label(self):
        runs = (
            EngineRun("perplexity", "best Android watch", "2026-06-29T12:00:00+00:00", "HU", "en", "Huawei Watch Fit 5 is mentioned.", ("source-a",), ("Huawei Watch Fit 5",), ("Huawei Watch Fit 5",), ("example.com",)),
            EngineRun("google_aio", "Huawei Watch Fit 5", "2026-06-29T12:02:00+00:00", "HU", "en", "Huawei Watch Fit 5 is cited from Huawei.", ("source-c",), ("Huawei Watch Fit 5",), ("Huawei Watch Fit 5",), ("consumer.huawei.com",)),
        )
