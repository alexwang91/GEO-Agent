...
from geo_agent.manual_only_providers import manual_only_provider_matrix
...
class V10SamplingProviderMatrixTests(unittest.TestCase):
    def test_manual_only_provider_statuses_are_registered(self):
        ...
        methods = {provider.provider_id: provider.access_method for provider in manual_only_provider_matrix()}
